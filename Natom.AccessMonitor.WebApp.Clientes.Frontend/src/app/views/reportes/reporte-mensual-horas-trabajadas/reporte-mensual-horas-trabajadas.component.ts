...
@Component({
  selector: 'app-reporte-mensual-horas-trabajadas',
  styleUrls: ['./reporte-mensual-horas-trabajadas.component.css'],
  templateUrl: './reporte-mensual-horas-trabajadas.component.html'
})

export class ReportesReporteMensualHorasTrabajadasComponent implements OnInit {
  ...
  onConsultar() {
    ...
    this.apiService.OpenNewTab("reportes/listados/reporte-mensual-horas-trabajadas?desde=" + encodeURIComponent(this.filtroFechaDesdeValue) + "&hasta=" + encodeURIComponent(this.filtroFechaHastaValue));
  }
}
