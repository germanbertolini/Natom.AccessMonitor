...
export class HorariosComponent implements OnInit {
  ...
  onNewClick() {
    this.routerService.navigate(['/horarios/' + encodeURIComponent(this.place_id) + '/new']);
  }

  onVerClick(id: string) {
    this.routerService.navigate(['/horarios/' + encodeURIComponent(this.place_id) + '/ver/' + encodeURIComponent(id)]);
  }
