...
using Natom.AccessMonitor.WebApp.Admin.Backend.Controllers;
using Natom.AccessMonitor.WebApp.Admin.Backend.DTO;
using Natom.AccessMonitor.WebApp.Admin.Backend.DTO.DataTable;
using Natom.AccessMonitor.WebApp.Admin.Backend.DTO.Goals;
using Natom.AccessMonitor.WebApp.Admin.Backend.DTO.Places;
    ...
    public class GoalsController : BaseController
    {
        ...
        public async Task<IActionResult> GetBasicsDataAsync([FromQuery] string encryptedId = null, [FromQuery] string clienteEncryptedId = null)
        {
            try
            {
                ...
                var clienteId = EncryptionService.Decrypt<int>(Uri.UnescapeDataString(clienteEncryptedId));
