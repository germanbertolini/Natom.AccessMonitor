...
import { SyncronizerDTO } from "src/app/classes/dto/syncronizer.dto";
...
export class ClientsCrudComponent implements OnInit {
  ...
  constructor(private httpClientService: HttpClient,
    ...
    this.crudUser = new UserDTO();
    this.crud.model = new Client();
    this.crud.model.users = new Array<UserDTO>();
    this.crud.model.syncs = new Array<SyncronizerDTO>();
  }
  ...
  onAddUserClick() {
    if (this.crudUser.first_name === undefined)     this.confirmDialogService.showError("Debe ingresar el NOMBRE.");
      ...
      this.crudUser = new UserDTO(); //LIMPIAMOS CAMPOS
