...
namespace Natom.AccessMonitor.WebApp.Clientes.Backend.DTO.Horarios
{
    public class HorarioDTO
    {
        ...
        public HorarioDTO From(ConfigTolerancia entity)
        {
            ...
            Status = entity.AplicaDesde.Date <= DateTime.Now.Date && (!entity.AplicaHasta.HasValue || (entity.AplicaHasta.HasValue && entity.AplicaHasta >= DateTime.Now.Date)) ? "VIGENTE" :
                        entity.AplicaDesde.Date > DateTime.Now.Date ? "PROGRAMADO"
                        : "CADUCADO";
